...
export const ProfileView = ({ data, actions }) => {
  ...
  // Requirement Logic: 4 letters & 1 number
  ...
  const handleUpdatePassword = async () => {
    ...
    setUpdating(true);
    const success = await actions.onChangePassword(
      passwords.current,
      passwords.new,
    );
    setUpdating(false);
  ...
  return (
    <View style={STYLES.container}>
      ...
      {/* Modal code for Changing Password */}
